...
const getObjects = () =>{
  return [
    new TouristObject(1,
      ...
      "/images/uchan-su.jpg",
      44.49249183071868, 34.09319240698239
    ),
    new TouristObject(2,
      "Мангуп-Кале",
    ...
    new TouristObject(4,
      ...
      44.430526158667874, 34.128408731940226
    ),
    new TouristObject(5,
      ...
      44.61311160035013, 33.49196520411152
    ),
    new TouristObject(6,
      "гора Ай Петри",
      "рядом с Кореизом",
      ...
      44.451813550171074, 34.06018122771535
    ),
    new TouristObject(7,
      "Мыс Фиолент",
      "Севастополь",
    ...
    new TouristObject(8,
      ...
      44.46793886760071, 34.1436514493995
    ),
    new TouristObject(9,
    ...
    new TouristObject(15,
      ...
      44.74145894063618, 33.923157369500274
    ),
